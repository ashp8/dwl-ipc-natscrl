...
static const char *prtscrn[] = {"/usr/bin/grim", "-", "|", "wl-copy", NULL};
...
static const Key keys[] = {
	...
	{ 0, XK_Print, spawn, SHCMD("geometry=$(slurp) && [ -n \"$geometry\" ] && grim -g \"$geometry\" ~/Pictures/screenshot-$(date +'%Y-%m-%d_%H-%M-%S').png") },
